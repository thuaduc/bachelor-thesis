...
\lstdefinestyle{mystyle}{
  ...
  stepnumber=1,
  frame=single,
  morekeywords=[0]{uint64_t, uintptr_t,class, public, private, void, const, if, else, for, while},
  keywordstyle=[0]\bfseries\color{FireBrick},
}
...
\lstset{
  ...
  autogobble,
  morekeywords={uint64_t, uint, class, public, private, protected, void, const, if, else, for, while},
